...
def vid_pipeline(img_original):
    ...
    out_img, curves, lanes, ploty = sliding_window(img_perspective, draw_windows=False)
    curverad = get_curve(img_original, curves[0], curves[1])
    lane_curve = np.mean([curverad[0], curverad[1]])
    img_overlay = draw_lanes(img_original, curves[0], curves[1])
...
def display(img_original, img_filter, img_window, img_overlay, curves, ploty):
